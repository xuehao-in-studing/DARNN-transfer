...
class DANN_with_DALSTM_Multi_Src(DANN_with_DALSTM):
    def __init__(self, X, y, T, num_hidden, batch_size, learning_rate=1e-3, epochs: int = 200,
                 model_path: str = None,
                 parallel: bool = False):
        super(DANN_with_DALSTM_Multi_Src, self).__init__(X, y, T, num_hidden, batch_size, learning_rate, epochs,
                                                         model_path,
                                                         parallel, )
    ...
    def forward(self, X, y_prev, alpha):
        ...
        return feature, val_pred, domain_pred
...
if __name__ == '__main__':
    ...
    model = DANN_with_DALSTM_Multi_Src(dummy_X_src, dummy_y_prev_src, T, num_hidden, batch)
    # torchinfo
    from torchinfo import summary

    _, val_pred, domain_pred = model(dummy_X_src, dummy_y_prev_src, 0.5)
